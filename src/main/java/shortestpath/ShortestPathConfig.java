...
public interface ShortestPathConfig extends Config {
    ...
    @ConfigItem(
        keyName = "followQuestHelper",
        name = "Follow Quest Helper",
        description = "Sets the target to the location of the next step in a quest if Quest Helper is active",
        position = 2,
        section = sectionSettings
    )
    default boolean followQuestHelper() {
        return false;
    }
